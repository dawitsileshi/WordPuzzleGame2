...
public class Assets {
    ...
    public com.example.wordpuzzlegame.model.Assets singleAsset(long word_code) {
        ...
        return new com.example.wordpuzzlegame.model.Assets(asset_id, image, wc);

    }

    public long insertAssets(com.example.wordpuzzlegame.model.Assets assets) {
