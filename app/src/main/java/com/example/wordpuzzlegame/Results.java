...
public class Results implements Parcelable {
    ...
    public long insertResult(com.example.wordpuzzlegame.model.Results results) {
    ...
    public ArrayList<com.example.wordpuzzlegame.model.Results> listResults() {

        ArrayList<com.example.wordpuzzlegame.model.Results> resultsArrayList = new ArrayList<>();
...
//            Cursor wordCursor = dataSource.singleItem(wordId, ItemTables.WORD_TABLE);
            ...
            com.example.wordpuzzlegame.model.Results results = new com.example.wordpuzzlegame.model.Results(id, gameType, score, total, timestamp, answers);
