...
public class Languages implements Parcelable {
    ...
    public ArrayList<com.example.wordpuzzlegame.model.Languages> languagesList() {

        Cursor cursor = dataSource.getAllLanguages();

        ArrayList<com.example.wordpuzzlegame.model.Languages> languagesList = new ArrayList<>();
        cursor.moveToFirst();
        ...
        while (!cursor.isAfterLast()) {
            ...
            com.example.wordpuzzlegame.model.Languages languages = new com.example.wordpuzzlegame.model.Languages(id, lang, alphabets);
    ...
    public long insertLanguage(com.example.wordpuzzlegame.model.Languages languages) {
    ...
    public com.example.wordpuzzlegame.model.Languages singleLanguage(long id) {
        ...
        if(singleData != null) {
            ...
            return new com.example.wordpuzzlegame.model.Languages(langId, language, alphabets);
