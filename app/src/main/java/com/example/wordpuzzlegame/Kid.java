...
public class Kid {
    ...
    public long addKid(com.example.wordpuzzlegame.model.Kid kid) {
    ...
    public ArrayList<com.example.wordpuzzlegame.model.Kid> kids() {

        Cursor kidCursor = dataSource.getAll(ItemTables.KID_TABLE);

        ArrayList<com.example.wordpuzzlegame.model.Kid> kids = new ArrayList<>();
        ...
        while(!kidCursor.isAfterLast()) {
            ...
            com.example.wordpuzzlegame.model.Kid kid = new com.example.wordpuzzlegame.model.Kid(name, gender, grade);
            kids.add(kid);
